...
public class Fenetre extends JFrame {
	...
	private void enregistrerEtat() {
		// Récupérer l'état courant de la fenêtre
		String texteCourant = texte.getText();
		boolean etatGras = gras;
		boolean etatItalique = italique;
		boolean etatRouge = rouge;
	
		// Créer une instance de Memento avec l'état courant
		Memento nouvelEtat = new Memento(texteCourant, etatGras, etatItalique, etatRouge);
	
		// Ajouter le nouvel état à la pile d'états
		memoire.ajouter(nouvelEtat);
		annuler.setEnabled(true);
		refaire.setEnabled(false);
	}
	...
	class Memento {
		...
		public Memento() {
			...
			// Créer la sauvegarde de l'état courant
			this.text = texteCourant;
			this.gras = etatGras;
			this.italique = etatItalique;
			this.rouge = etatRouge;
		}
